...
namespace BehaviourMachine
{
    ...
    public class InternalBlackboard : MonoBehaviour
    {
        ...
        public static bool SendEventToAll(string eventName)
        {
            ...
            {
                var __array1 = UnityEngine.Object.FindObjectsOfType(typeof(InternalBlackboard));
                var __arrayLength1 = __array1.Length;
                for (int __i1 = 0; __i1 < __arrayLength1; ++__i1)
                {
                    var blackboard = (InternalBlackboard)__array1[__i1];
        ...
        public static bool SendEventToAll(int eventID)
        {
            bool eventUsed = false;
            {
                var __array2 = UnityEngine.Object.FindObjectsOfType(typeof(InternalBlackboard));
                var __arrayLength2 = __array2.Length;
                for (int __i2 = 0; __i2 < __arrayLength2; ++__i2)
                {
                    var blackboard = (InternalBlackboard)__array2[__i2];
        ...
        public bool BroadcastEvent(int eventID)
        {
            ...
            {
                // foreach(var child in transform)
                var __enumerator4 = (transform).GetEnumerator();
                while (__enumerator4.MoveNext())
                {
                    var child = (Transform)__enumerator4.Current;
                    {
                        var blackboard = child.GetComponent<InternalBlackboard>();
                        if (blackboard != null)
