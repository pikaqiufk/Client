...
namespace BehaviourMachine
{
    ...
    public class TypeUtility
    {
        ...
        public static Assembly[] loadedAssemblies
        {
            get
            {
                if (s_LoadedAssemblies == null)
                {
                    ...
                    {
                        var __array1 = s_LoadedAssemblies;
                        var __arrayLength1 = __array1.Length;
                        for (int __i1 = 0; __i1 < __arrayLength1; ++__i1)
                        {
                            var asm = (Assembly)__array1[__i1];
                            {
        ...
        public static System.Type[] GetDerivedTypes(System.Type baseType)
        {
            ...
            {
                var __array2 = TypeUtility.loadedAssemblies;
                var __arrayLength2 = __array2.Length;
                for (int __i2 = 0; __i2 < __arrayLength2; ++__i2)
                {
                    var asm = (Assembly)__array2[__i2];
                    {
                        // Get types
                        Type[] exportedTypes;
