    ...
    public class NameFilter : IScanFilter
    {
            ...
            {
                {
                    ...
                    var __enumerator1 = (inclusions_).GetEnumerator();
                    while (__enumerator1.MoveNext())
                    {
                        var r = (Regex)__enumerator1.Current;
                        {
                            if (r.IsMatch(name))
                            {
                                result = true;
        ...
        public bool IsExcluded(string name)
        {
            bool result = false;
            {
                ...
                var __enumerator2 = (exclusions_).GetEnumerator();
                while (__enumerator2.MoveNext())
                {
                    var r = (Regex)__enumerator2.Current;
                    {
                        if (r.IsMatch(name))
                        {
                            result = true;
