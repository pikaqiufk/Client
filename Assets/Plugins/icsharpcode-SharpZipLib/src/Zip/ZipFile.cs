...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipFile : IEnumerable, IDisposable
    {
        ...
        public void BeginUpdate(IArchiveStorage archiveStorage, IDynamicDataSource dataSource)
        {
            ...
            {
                var __array1 = entries_;
                var __arrayLength1 = __array1.Length;
                for (int __i1 = 0; __i1 < __arrayLength1; ++__i1)
                {
                    var entry = (ZipEntry)__array1[__i1];
                    {
            ...
            int idx = 0;
            {
                ...
                var __enumerator2 = (updates_).GetEnumerator();
                while (__enumerator2.MoveNext())
                {
                    var update = (ZipUpdate)__enumerator2.Current;
                    {
        ...
        */
        ...
        void RunUpdates()
        {
            ...
            try
            {
                {
                    // foreach(var update in updates_)
                    var __enumerator3 = (updates_).GetEnumerator();
                    while (__enumerator3.MoveNext())
                    {
                        var update = (ZipUpdate)__enumerator3.Current;
                        {
                            if (update != null)
                            {
                ...
                {
                    // foreach(var update in updates_)
                    var __enumerator4 = (updates_).GetEnumerator();
                    while (__enumerator4.MoveNext())
                    {
                        var update = (ZipUpdate)__enumerator4.Current;
                        {
                            if (update != null)
                            {
                ...
                {
                    // foreach(var update in updates_)
                    var __enumerator5 = (updates_).GetEnumerator();
                    while (__enumerator5.MoveNext())
                    {
                        var update = (ZipUpdate)__enumerator5.Current;
                        {
                            if (update != null)
                            {
