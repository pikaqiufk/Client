    ...
    public class JsonMapper
    {
        ...
        private static void AddArrayMetadata(Type type)
        {
            ...
            if (type.GetInterface("System.Collections.IList") != null)
                data.IsList = true;
            {
                var __array1 = type.GetProperties();
                var __arrayLength1 = __array1.Length;
                for (int __i1 = 0; __i1 < __arrayLength1; ++__i1)
                {
                    var p_info = (PropertyInfo)__array1[__i1];
                    {
                        if (p_info.Name != "Item")
                            continue;
        ...
        private static void AddObjectMetadata(Type type)
        {
            ...
            {
                var __array2 = type.GetProperties();
                var __arrayLength2 = __array2.Length;
                for (int __i2 = 0; __i2 < __arrayLength2; ++__i2)
                {
                    var p_info = (PropertyInfo)__array2[__i2];
                    {
                        if (p_info.Name == "Item")
                        {
                            ParameterInfo[] parameters = p_info.GetIndexParameters();
                                        ...
                                        int depth)
        {
            ...
            if (obj is Array)
            {
                writer.WriteArrayStart();
                {
                    ...
                    var __enumerator6 = ((Array)obj).GetEnumerator();
                    while (__enumerator6.MoveNext())
                    {
                        var elem = (object)__enumerator6.Current;
            ...
            if (obj is IList)
            {
                writer.WriteArrayStart();
                {
                    ...
                    var __enumerator7 = ((IList)obj).GetEnumerator();
                    while (__enumerator7.MoveNext())
                    {
                        var elem = (object)__enumerator7.Current;
                        WriteValue(elem, writer, writer_is_private, depth + 1);
                    }
                }
                writer.WriteArrayEnd();
            ...
            if (obj is IDictionary)
            {
                writer.WriteObjectStart();
                {
                    ...
                    var __enumerator8 = ((IDictionary)obj).GetEnumerator();
                    while (__enumerator8.MoveNext())
                    {
                        var entry = (DictionaryEntry)__enumerator8.Current;
                        {
            ...
            writer.WriteObjectStart();
            {
                ...
                var __enumerator9 = (props).GetEnumerator();
                while (__enumerator9.MoveNext())
                {
                    var p_data = (PropertyMetadata)__enumerator9.Current;
                    {
                        if (p_data.IsField)
                        {
