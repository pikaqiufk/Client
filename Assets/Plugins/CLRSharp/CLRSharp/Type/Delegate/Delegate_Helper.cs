...
namespace CLRSharp
{
    ...
    public class Delegate_BindTool_Ret<T1, TRet> : IDelegate_BindTool
    {
        ...
        public Delegate CreateDele(Type deletype, ThreadContext context, CLRSharp_Instance _this, IMethod _method)
        {
            Action act = (T1 p1) =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        context.environment.logger.Log_Error("Delegate_BindTool_Ret<T1, TRet> can not cast from " + o.GetType() + " to " + type +
                                                             " for return value.");
                        throw;
                    }
                }  
    ...
    public class Delegate_BindTool_Ret<T1, T2, TRet> : IDelegate_BindTool
    {
        ...
        public Delegate CreateDele(Type deletype, ThreadContext context, CLRSharp_Instance _this, IMethod _method)
        {
            Action act = (T1 p1, T2 p2) =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        context.environment.logger.Log_Error("Delegate_BindTool_Ret<T1, T2, TRet> can not cast from " + o.GetType() + " to " + type +
                                                             " for return value.");
                        throw;
                    }
                }
    ...
    public class Delegate_BindTool_Ret<T1, T2, T3, TRet> : IDelegate_BindTool
    {
        ...
        public Delegate CreateDele(Type deletype, ThreadContext context, CLRSharp_Instance _this, IMethod _method)
        {
            Action act = (T1 p1, T2 p2, T3 p3) =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        context.environment.logger.Log_Error(
                            "Delegate_BindTool_Ret<T1, T2, T3, TRet> can not cast from " + o.GetType() + " to " + type +
                            " for return value.");
                        throw;
                    }
                }
    ...
    public class Delegate_BindTool_Ret<T1, T2, T3, T4, TRet> : IDelegate_BindTool
    {
        ...
        public Delegate CreateDele(Type deletype, ThreadContext context, CLRSharp_Instance _this, IMethod _method)
        {
            Action act = (T1 p1, T2 p2, T3 p3, T4 p4) =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        context.environment.logger.Log_Error("Delegate_BindTool_Ret<T1, TRet> can not cast from " +
                                                             o.GetType() + " to " + type +
                                                             " for return value.");
                        throw;
                    }
    ...
    public class Delegate_BindTool_Ret<T1, T2, T3, T4, T5, TRet> : IDelegate_BindTool
    {
        delegate TRet Action(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5);
        public Delegate CreateDele(Type deletype, ThreadContext context, CLRSharp_Instance _this, IMethod _method)
        {
            Action act = (T1 p1, T2 p2, T3 p3, T4 p4, T5 p5) =>
            {
                object o = _method.Invoke(context, _this, new object[] { p1, p2, p3, p4, p5 }, true, true);
                if (o is VBox)
                {
                    o = (o as VBox).BoxDefine();
                }
    ...
    public class Delegate_BindTool_Ret<T1, T2, T3, T4, T5, T6, TRet> : IDelegate_BindTool
    {
        delegate TRet Action(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6);
        public Delegate CreateDele(Type deletype, ThreadContext context, CLRSharp_Instance _this, IMethod _method)
        {
            Action act = (T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6) =>
            {
                object o = _method.Invoke(context, _this, new object[] { p1, p2, p3, p4, p5, p6 }, true, true);
                if (o is VBox)
                {
                    o = (o as VBox).BoxDefine();
                }
