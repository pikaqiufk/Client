...
namespace CLRSharp
{
    ...
    public class CodeBody
    {
        ...
        public class OpCode
        {
            ...
            public Func<object, object, object> binaryOperation;
            public void InitToken(ThreadContext context, CodeBody body, object _p)
            {
                switch (code)
                {
                    ...
                    case CodeEx.Ldvirtftn:
                        ...
                        break;
                    case CodeEx.Ldc_I4:
                        this.tokenI32 = (int)_p.Convert<int>();
                        break;
                    ...
                    case CodeEx.Ldc_I4_8:
                        ...
                        break;
                    case CodeEx.Ldc_I8:
                        this.tokenI64 = (Int64)_p.Convert<Int64>();
                        break;
                    case CodeEx.Ldc_R4:
                        this.tokenR32 = (float)_p.Convert<float>();;
                        break;
                    case CodeEx.Ldc_R8:
                        this.tokenR64 = (double)_p.Convert<double>();;
                        break;
