    ...
    public class MD5
    {
        ...
        public string Value
        {
            get
            {
                ...
                var m_byteInputLength0 = m_byteInput.Length;
                for (var i = 0; i < m_byteInputLength0; i++)
                {
            ...
            set
            {
                ...
                var valueLength1 = value.Length;
                for (var i = 0; i < valueLength1; i++)
                {
        ...
        public byte[] ValueAsByte
        {
            get
            {
                ...
                var m_byteInputLength2 = m_byteInput.Length;
                for (var i = 0; i < m_byteInputLength2; i++)
                {
                    bt[i] = m_byteInput[i];
                }
                return bt;
            ...
            set
            {
                ...
                m_byteInput = new byte[value.Length];
                var valueLength3 = value.Length;
                for (var i = 0; i < valueLength3; i++)
                {
        ...
        protected byte[] CreatePaddedBuffer()
        {
            ...
            var temp = (448 - ((m_byteInput.Length*8)%512)); //temporary 
            ...
            var m_byteInputLength4 = m_byteInput.Length;
            for (var i = 0; i < m_byteInputLength4; i++)
            {
        ...
        public class MD5ChangingEventArgs : EventArgs
        {
            ...
            {
                var NewData = new byte[data.Length];
                var dataLength6 = data.Length;
                for (var i = 0; i < dataLength6; i++)
                {
        ...
        public class MD5ChangedEventArgs : EventArgs
        {
            ...
            {
                var NewData = new byte[data.Length];
                var dataLength7 = data.Length;
                for (var i = 0; i < dataLength7; i++)
                {
                    NewData[i] = data[i];
                }
            ...
            {
                var NewData = new byte[data.Length];
                var dataLength8 = data.Length;
                for (var i = 0; i < dataLength8; i++)
                {
                    NewData[i] = (byte) data[i];
                }
