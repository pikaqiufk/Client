...
namespace MoPhoGames.USpeak.Core
{
    ...
    public class USpeakAudioManager
    {
        ...
        {
            {
                var __list1 = audioPool;
                var __listCount1 = __list1.Count;
                for (int __i1 = 0; __i1 < __listCount1; ++__i1)
                {
                    var src = (AudioSource)__list1[__i1];
                    {
                        src.Stop();
                    }
                }
        ...
        {
            {
                var __list2 = clipPool;
                var __listCount2 = __list2.Count;
                for (int __i2 = 0; __i2 < __listCount2; ++__i2)
                {
                    var clip = (AudioClip)__list2[__i2];
                    {
