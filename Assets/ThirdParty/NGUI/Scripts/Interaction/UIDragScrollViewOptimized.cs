...
public class UIDragScrollViewOptimized : MonoBehaviour
{
	/// <summary>
    ...
    [HideInInspector]
    [SerializeField]
    UIScrollViewOptimized draggablePanel;

	Transform mTrans;
    UIScrollViewOptimized mScroll;
	...
	void FindScrollView ()
	{
        ...
        UIScrollViewOptimized sv = NGUITools.FindInParents<UIScrollViewOptimized>(mTrans);
	...
	void OnPress (bool pressed)
	{
		...
		if (scrollView && enabled && NGUITools.GetActive(gameObject))
		{
			...
			{
                scrollView = NGUITools.FindInParents<UIScrollViewOptimized>(mTrans);
				mScroll = scrollView;
			}
		}
	}
