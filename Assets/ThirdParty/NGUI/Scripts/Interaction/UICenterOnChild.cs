...
public class UICenterOnChild : MonoBehaviour
{
    ...
    public delegate void OnLostFocusCallback(GameObject centeredObject);
    ...
    public OnLostFocusCallback onLostFocus;
    ...
    public bool CenterScaleChangeZ;
    public float CenterScaleZPos;

	UIScrollView mScrollView;

    GameObject _mCenteredObject;

    private GameObject mCenteredObject {
        get { return _mCenteredObject; }
        set
        {
            if (_mCenteredObject == value) return;
            if (onLostFocus != null && _mCenteredObject != null) onLostFocus(_mCenteredObject);
            _mCenteredObject = value;
        }
    }
