...
public class UIToggle : UIWidgetContainer
{
	...
	[HideInInspector][SerializeField] public UISprite checkSprite = null;
    ...
    public bool valueEx
    {
        ...
        {
            if (!mStarted) startsActive = value;
            else if (group == 0 || value || optionCanBeNone || !mStarted) SetEx(value);
        }
    }
	...
	public void Set (bool state)
	{
		...
		else if (mIsActive != state)
		{
			...
			{
				aa = ActiveAnimation.Play(activeAnimation, null,
    ...
    private ActiveAnimation aa;
    public void SetEx(bool state)
    {
        if (validator != null && !validator(state)) return;
        ...
        else if (mIsActive != state)
        {
            ...
            if (activeSprite != null)
            {
                ...
                {
                    activeSprite.transform.localScale = new Vector3(0.01f, 0.01f, 1);
                }
