...
public class ActiveAnimation : MonoBehaviour
{
    ...
    public bool isPlaying
    {
        get
        {
            ...
            {
                // foreach(var state in mAnim)
                var __enumerator1 = (mAnim).GetEnumerator();
                while (__enumerator1.MoveNext())
                {
                    var state = (AnimationState)__enumerator1.Current;
                    {
    ...
    public void Finish()
    {
        if (mAnim != null)
        {
            {
                // foreach(var state in mAnim)
                var __enumerator2 = (mAnim).GetEnumerator();
                while (__enumerator2.MoveNext())
                {
                    var state = (AnimationState)__enumerator2.Current;
                    {
    ...
    public void Reset()
    {
        if (mAnim != null)
        {
            {
                // foreach(var state in mAnim)
                var __enumerator3 = (mAnim).GetEnumerator();
                while (__enumerator3.MoveNext())
                {
                    var state = (AnimationState)__enumerator3.Current;
                    {
    ...
    void Update()
    {
        ...
        else if (mAnim != null)
        {
            ...
            {
                // foreach(var state in mAnim)
                var __enumerator4 = (mAnim).GetEnumerator();
                while (__enumerator4.MoveNext())
                {
                    var state = (AnimationState)__enumerator4.Current;
                    {
                        if (!mAnim.IsPlaying(state.name)) continue;
    ...
    void Play(string clipName, Direction playDirection)
    {
        ...
        if (mAnim != null)
        {
            ...
            {
                // foreach(var state in mAnim)
                var __enumerator5 = (mAnim).GetEnumerator();
