...
public class NGUIJson
{
    ...
    static void LoadSpriteData(UIAtlas atlas, Hashtable decodedHash)
    {
        ...
        Hashtable frames = (Hashtable)decodedHash["frames"];
        {
            ...
            var __enumerator1 = (frames).GetEnumerator();
            while (__enumerator1.MoveNext())
            {
                var item = (System.Collections.DictionaryEntry)__enumerator1.Current;
                {
...
*/
    ...
    protected static bool serializeDictionary(Dictionary<string, string> dict, StringBuilder builder)
    {
        ...
        bool first = true;
        {
            ...
            var __enumerator2 = (dict).GetEnumerator();
            while (__enumerator2.MoveNext())
            {
                var kv = __enumerator2.Current;
                {
                    if (!first)
                        builder.Append(", ");
