...
public class NGUITransformInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        bool widgets = false;
        {
            ...
            var __enumerator1 = (serializedObject.targetObjects).GetEnumerator();
            while (__enumerator1.MoveNext())
            {
                var obj = (Object)__enumerator1.Current;
                {
    ...
    Axes CheckDifference(SerializedProperty property)
    {
        ...
        if (property.hasMultipleDifferentValues)
        {
            ...
            {
                // foreach(var obj in serializedObject.targetObjects)
                var __enumerator2 = (serializedObject.targetObjects).GetEnumerator();
                while (__enumerator2.MoveNext())
                {
                    var obj = (Object)__enumerator2.Current;
                    {
    ...
    void DrawRotation(bool isWidget)
    {
        GUILayout.BeginHorizontal();
        {
            ...
            else if (altered != Axes.None)
            {
                ...
                {
                    // foreach(var obj in serializedObject.targetObjects)
                    var __enumerator3 = (serializedObject.targetObjects).GetEnumerator();
                    while (__enumerator3.MoveNext())
                    {
                        var obj = (Object)__enumerator3.Current;
                        {
                            Transform t = obj as Transform;
