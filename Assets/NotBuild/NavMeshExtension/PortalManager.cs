...
namespace NavMeshExtension
{
    ...
    public class PortalManager : MonoBehaviour
    {
        ...
        {
            {
                // foreach(var parent in instance.transform)
                var __enumerator1 = (instance.transform).GetEnumerator();
                while (__enumerator1.MoveNext())
                {
                    var parent = (Transform)__enumerator1.Current;
                    {
                        if (!portals.ContainsKey(parent))
                        {
                            portals.Add(parent, new List<Transform>());
                            {
                                ...
                                var __enumerator3 = (parent).GetEnumerator();
        ...
        public class PortalPath
        {
            ...
            public Vector3[] GetShortestPath()
            {
                ...
                {
                    // foreach(var portal in portals.Keys)
                    var __enumerator2 = (portals.Keys).GetEnumerator();
                    while (__enumerator2.MoveNext())
                    {
                        var portal = (Transform)__enumerator2.Current;
                        myNodes.Add(portal);
                    }
                }
