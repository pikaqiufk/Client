...
public class UILabelWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("InitDictionary", InitDictionary);
		L.RegFunction("__eq", op_Equality);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.RegVar("keepCrispWhenShrunk", get_keepCrispWhenShrunk, set_keepCrispWhenShrunk);
		L.RegVar("DictionaryId", get_DictionaryId, set_DictionaryId);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int InitDictionary(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_DictionaryId(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UILabel obj = (UILabel)o;
			int ret = obj.DictionaryId;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index DictionaryId on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_DictionaryId(IntPtr L)
	{
		object o = null;
