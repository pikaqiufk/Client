...
public class UISpriteWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("atlasAndSprite", null, set_atlasAndSprite);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_atlasAndSprite(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			obj.atlasAndSprite = arg0;
			return 0;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index atlasAndSprite on a nil value" : e.Message);
		}
	}
