...
public class UIWidgetWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("SkippedRenderQueue", get_SkippedRenderQueue, set_SkippedRenderQueue);
		L.RegVar("ignoreBounds", get_ignoreBounds, set_ignoreBounds);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_SkippedRenderQueue(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIWidget obj = (UIWidget)o;
			int ret = obj.SkippedRenderQueue;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index SkippedRenderQueue on a nil value" : e.Message);
		}
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_ignoreBounds(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIWidget obj = (UIWidget)o;
			bool ret = obj.ignoreBounds;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index ignoreBounds on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_SkippedRenderQueue(IntPtr L)
	{
		object o = null;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_ignoreBounds(IntPtr L)
	{
		object o = null;
