...
public class UIProgressBarWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("MValue", get_MValue, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_MValue(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIProgressBar obj = (UIProgressBar)o;
			float ret = obj.MValue;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index MValue on a nil value" : e.Message);
		}
	}
