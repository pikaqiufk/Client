...
/// </summary>
[Serializable]
public class SourceBindingProperty
{
    [SerializeField] private Component mTarget;
    [SerializeField] private string mName;

    private readonly INotifyPropertyChanged mNotifyPropertyChanged;
    ...
    public INotifyPropertyChanged GetNotifyPropertyChanged()
    {
        return mNotifyPropertyChanged;
    }
    ...
    public override bool Equals(object obj)
    {
        ...
        if (obj is SourceBindingProperty)
        {
            var pb = obj as SourceBindingProperty;
