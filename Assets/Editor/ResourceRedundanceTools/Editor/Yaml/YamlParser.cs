...
namespace ResourceRedundance.Yaml.Grammar
{
    public partial class YamlParser
    {
        ...
        private Scalar ParseBlockScalar(out bool success)
        {
            ...
            scalar.Text = ParseBracketText(out success);
            if (success) { ClearError(errorCount); return scalar; }

            scalar.Text = ParseBraceText(out success);
            if (success) { ClearError(errorCount); return scalar; }
        ...
        private string ParseBracketText(out bool success)
        {
            int errorCount = Errors.Count;
            StringBuilder text = new StringBuilder();
            int start_position = position;
        ...
        private string ParseBraceText(out bool success)
        {
            int errorCount = Errors.Count;
            StringBuilder text = new StringBuilder();
            int start_position = position;
