...
namespace ResourceRedundance.CodeLib
{
    /// <summary>
    ...
    public class StringHelper
    {
        ...
        public static string[] SplitIntoLines(string text)
        {
            ...
            StringBuilder line = new StringBuilder();
            {
                ...
                var __enumerator1 = (text).GetEnumerator();
                while (__enumerator1.MoveNext())
                {
                    var ch = (char)__enumerator1.Current;
                    {
                        switch (ch)
                        {
                            case '\r':
        ...
        public static string ContactWithDelimSkipSome(IEnumerable<string> items, string delim, string skip)
        {
            ...
            bool isFirst = true;
            {
                ...
                var __enumerator2 = (items).GetEnumerator();
                while (__enumerator2.MoveNext())
                {
                    var item = (string)__enumerator2.Current;
                    {
        ...
        public static string ContactWithDelim(IEnumerable<string> items, string delim, string initialValue, string endValue)
        {
            ...
            {
                // foreach(var item in items)
                var __enumerator3 = (items).GetEnumerator();
                while (__enumerator3.MoveNext())
                {
                    var item = (string)__enumerator3.Current;
                    {
                        if (isFirst)
                        {
                            isFirst = false;
        ...
        public static string ContactWithDelim<T>(IEnumerable<T> items, string delim, string initialValue, string endValue)
        {
            ...
            {
                // foreach(var item in items)
                var __enumerator4 = (items).GetEnumerator();
        ...
        public static string[] GetWords(string text)
        {
            ...
            {
                // foreach(var ch in text)
                var __enumerator5 = (text).GetEnumerator();
                while (__enumerator5.MoveNext())
                {
                    var ch = (char)__enumerator5.Current;
                    {
                        switch (ch)
                        {
                            case ' ':
        ...
        public static Dictionary<string, int> CountWordFrequency(string article, string delimiters)
        {
            ...
            List<char> buffer = new List<char>();
            {
                ...
                var __enumerator6 = (article).GetEnumerator();
                while (__enumerator6.MoveNext())
                {
                    var c = (char)__enumerator6.Current;
                    {
