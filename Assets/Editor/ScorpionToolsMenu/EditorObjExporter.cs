        ...
        {
            {
                ...
                var __enumerator7 = (materialList).GetEnumerator();
                while (__enumerator7.MoveNext())
                {
                    var kvp = (KeyValuePair<string, ObjMaterial>)__enumerator7.Current;
                    {
                        sw.Write("\n");
                        sw.Write("newmtl {0}\n", kvp.Key);
