...
namespace PigeonCoopToolkit.Effects.Trails.Editor
{
    ...
    public class TrailEditor_Base : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!ExcludedDefaultPropties.Contains("TrailData.SharedMaterial"))
            {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("TrailData.SharedMaterial"), new GUIContent("Share"), GUILayout.Width(70));
            }
